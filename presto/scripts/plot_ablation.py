...
OURMETHOD = "PRESTO"
METHOD_MAPPING = {
    'ours_pcd': 'Point-Cloud Conditioning',
    'ours_nocost': 'Training Without TrajOpt',
    'ours': OURMETHOD,
}
...
def plot_itr_data(data, metrics, iterations, domains):
    ...
    colors = {
        'Point-Cloud Conditioning': '#D58FD3',
        'Training Without TrajOpt': '#7C8AB6',
        OURMETHOD: 'blue',
    }
        ...
        for i, domain in enumerate(domains):
            ...
            for baseline_key, baseline_val in data.items():
                ...
                if times:
                    ...
                    print(f"Baseline: {baseline_key}, Domain: {domain}, Metric: {metric}, Values: {np.average(values_mean[1:])}")
    ...
    # Save SVG
    plt.savefig('ablation.svg', format='svg', dpi=1200)
